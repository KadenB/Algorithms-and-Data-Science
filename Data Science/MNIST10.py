...
# whole = pca.fit_transform(X_train)

def get_clusters(comoponents = 200, show_plot = True):
     ...
     cluster_centers = np.dot(evecs.T, cluster_centers.T).T
